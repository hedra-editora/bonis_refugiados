...
segundo o \versal{ACNUR}, a agência da \versal{ONU} para refugiados\footnote{ Ibid}. A~maioria dos refugiados veio de Afeganistão, Iraque e Síria, que enfrenta
...
antes pelo polêmico acordo da \versal{UE} com a Turquia para que o país recebesse
...
atuação da \versal{OTAN} no Mar Egeu e em apertar o cerco contra traficantes de
...
% LINK NÃO FUNCIONA
% Leia mais em:
% {https://ushmm.org/wlc/en/article.php?ModuleId=10005214}
,}
 ``um resultado da
