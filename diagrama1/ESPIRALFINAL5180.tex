...
por dia. Em março, havia um clima de incerteza no vilarejo, descreve
ela. A~fronteira com a República da Macedônia ficava cada vez menos
...
refugiados acabaram se aglomerando em acampamentos informais, em
condições inadequadas.

Essa foi o retrato dos três meses que antecederam o fim do centro de
transição, conforme Colpaert, uma das responsáveis pela coordenação das
atividades médicas do \versal{MSF} em Idomeni, os entendeu. A última, e mais
caótica, fase do local começou com o fechamento em definitivo da rota
...
fumaça tóxica de fogueiras alimentadas até mesmo com plástico. Desta
...
estavam bloqueados por tendas de refugiados que julgaram mais adequadas
como bases para seus abrigos as pedras a assentar os trilhos do que o
solo das plantações.
...
água, entre outros produtos. Espalhados pelo centro, ao menos dois
trailers também lucravam ofertando desde batata frita e hambúrgueres a
carregadores de celular àqueles que podiam pagar por esses itens.

O esforço dos atores humanitários para oferecer comida a todos, enquanto
isso, nem sempre era suficiente. Em seus melhores dias, o grupo social
...
transição, refletido na forma como que eles respondiam a algumas
...
Do contêiner da cozinha, não podia"-se ver o fim da fila de refugiados
...
Aqueles que aguardavam, o faziam muito mais vezes sob chuva do que sol.
...
Discussões acaloradas e forte descontentamento por parte dos refugiados
surgiam destas situações, agravadas pela frustração dos residentes do
centro de transição. O~clima pesado de apreensão criava o combustível a
...
mesmo que temporária e para a organização mais eficiente da fila,
...
ele. ``Não havia acomodação, a comida era muito ruim. Não havia vida'',
continuou.
...
deste detalhe pareceu surpreender aqueles refugiados que o compreendiam
e o espiavam timidamente.

``Só quero continuar meus estudos, aprender inglês'', contou. ``Amo
matemática. Talvez até queira um trabalho em algum banco'', confessou
ele.

Na Grécia, naquele momento, esse parecia um sonho um pouco distante. A~situação em Oreokastro, afinal, não era muito melhor do que a vida em
Idomeni. E~isso aumentava a frustração de Raed.

``Quero seguir para outro país. Não posso morar na Síria porque meu país
está em guerra'', disse. ``Só quero uma vida'', continuou. ``Mas não
...
foi superada pelos atendimentos de nível secundário, uma vez que a maior
parte dos residentes do centro de transição passou a ser composta por
mulheres (muitas delas grávidas), crianças, idosos e pessoas portadoras
...
pré"-natal para gestantes. O~MdM tive que criar um cartão médico para
...
criou um ambiente propício para a alta incidência de doenças infeciosas
...
infecção'', lembra Korina Kanistra.
...
mídia internacional e nas agendas de políticos europeus, mas esqueceu"-se
...
nestes casos. ``Não é fácil aceitar os nossos limites'', desabafa
Colpaert.
...
complexo porque os médicos do centro não podiam receitar drogas
psiquiátricas, e os hospitais públicos não conseguiam lidar com a
demanda. ``Víamos gente perdendo a esperança por todo lado'', relata
Kanistra.

A sensação de desespero é um sentimento que Youssef\footnote{ O nome do refugiado não foi revelado por completo
para proteger sua identidade.} 
reconhece. Ele e o irmão foram transferidos para Oreokastro após a
...
contava o porquê permaneceu no vilarejo grego durante meses, seu olhar
perdeu"-se em algum ponto distante.

``Achávamos que a fronteira iria se abrir um dia'', disse. ``Tínhamos
essa esperança durante o período que vivemos lá'', continuou. ``Mas,
...
2016. Como a maior parte dos refugiados sírios na Europa, partiu para a
...
``Quando a minha vez chegou, a fronteira se fechou'', disse ele. ``Eu
tinha todos os documentos, mas foi tarde demais'', contou decepcionado.
...
auxiliarem as organizações humanitárias a distribuirem alimentos no
...
completar meus estudos. Depois, vou trabalhar'', planejava ele.
...
registrados. De acordo com o \versal{MSF}, cerca de dez mulheres solicitavam o
aborto por semana no vilarejo. Na Grécia, o procedimento é legalizado.
...
incertezas sobre o futuro'', explica Colpaert.
...
humanitários que atuaram nas fases finais do centro de transição.
``Nunca sabia o que dizer a eles'', reconhece Kanistra. ``O sentimento
...
que podemos fazer?'', disse Raed. Em sua tenda, Youssef estava
