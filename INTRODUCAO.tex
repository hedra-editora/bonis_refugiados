...
continente: 84\% dos que estão sob o mandato da \versal{UNHCR} vivem em países em
...
grupo em relação a sua população\footnote{Edwards, Adrian. \emph{Global forced
  ...
  {unhcr.org/} (20 de
  junho de 2016){]} e \emph{\versal{UNHCR} - Global Trends: Forced Displacement 2016;}
...
pedir asilo às autoridades locais. Até o final de 2016, segundo a \versal{ONU},
cerca de 2,8 milhões de pessoas eram \{solicitantes de asilo}
\footnote{\emph{Tendências Globais sobre
...
\emph{internally displaced people}). Segundo a \versal{ONU}, existem 40,3 milhões
...
Acompanhando a expansão dessas crises, a \versal{ACNUR} passou a atuar no mundo
...
países integrantes da \versal{ONU} vêm enfrentando novos desafios, em especial
...
\imagemgrande{Médicos e enfermeiros voluntário trabalhavam em ritmo intenso na noite de 9 de outubro de 2015 para atender centenas de refugiados que passavam por Idomeni rumo ao norte da Europa.}{./img/CSC_0047.jpg}
